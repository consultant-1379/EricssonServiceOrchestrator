...
//import com.ericsson.eso.services.api.rest.ServiceController;
//import com.ericsson.eso.services.api.rest.responsedata.ServiceInstanceData;
//
///**
...
////        ServiceInstanceData r1 = mockHotel("shouldCreateRetrieveDelete");
...
////        ServiceInstanceData r1 = mockHotel("shouldCreateAndUpdate");
////        byte[] r1Json = toJson(r1);
////        //CREATE
////        MvcResult result = mvc.perform(post("/example/v1/hotels")
////                .content(r1Json)
...
////        long id = getResourceIdFromUrl(result.getResponse().getRedirectedUrl());
////
////        ServiceInstanceData r2 = mockHotel("shouldCreateAndUpdate2");
////        //r2.setId(id);
...
//
//
//    private ServiceInstanceData mockHotel(String prefix) {
//        ServiceInstanceData r = new ServiceInstanceData();
